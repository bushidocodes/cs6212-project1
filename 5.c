...
maximum number of pages. Out of all these permutations, the task is to find that
...
contiguous order (see explanation for better understanding).
Input:
...
The second line contains N space separated positive integers denoting the pages of each
book.
